 ...
 */
class User extends \Jet\Domain\System\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     * {@inheritDoc}
     */
    public function assignLocation(\Jet\Domain\System\Entity\Location $location): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'assignLocation', [$location]);

        parent::assignLocation($location);
    }

    /**
     * {@inheritDoc}
     */
    public function dissociateLocation(\Jet\Domain\System\Entity\Location $location): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'dissociateLocation', [$location]);

        parent::dissociateLocation($location);
    }

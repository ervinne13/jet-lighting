 ...
 */
class ItemStockSummary extends \Jet\Domain\PLD\Entity\ItemStockSummary implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'item', 'quantity'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ItemStockSummary $proxy) {
